...
public class SearchBusinessEventsAdapter extends RecyclerView.Adapter<SearchBusinessEventsAdapter.ViewHolder> {
    ...
    public SearchBusinessEventsAdapter(Context context, List<EventdataItem> stringArrayList) {
