...
import com.numnu.android.fragments.search.SearchBusinessItemsListFragment;
...
public class SearchBusinessItemTagsAdapter extends RecyclerView.Adapter<SearchBusinessItemTagsAdapter.ViewHolder> {

    Context context;
    String businessId,eventId;
    List<EventTagsDataItem> list = new ArrayList<>();

    public SearchBusinessItemTagsAdapter(Context context, String businessId, List<EventTagsDataItem> stringArrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SearchBusinessItemsListFragment businessItemsListFragment= SearchBusinessItemsListFragment.newInstance(holder.textViewName.getText().toString(),businessId, String.valueOf(eventBusinessesResponse.getTagid()));
