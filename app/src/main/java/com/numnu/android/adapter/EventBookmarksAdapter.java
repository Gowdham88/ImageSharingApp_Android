...
public class EventBookmarksAdapter extends RecyclerView.Adapter<EventBookmarksAdapter.ViewHolder> {
    ...
    public EventBookmarksAdapter(Context context, String eventId, List<DataItem> stringArrayList) {
