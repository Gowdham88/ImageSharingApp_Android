...
public class SearchHomePostAdapter extends RecyclerView.Adapter<SearchHomePostAdapter.ViewHolder> {

    Context context;
    List<HomepostResp> postlist = new ArrayList<>();
    ...
    public SearchHomePostAdapter(Context context, List<HomepostResp> stringArrayList) {
        this.context=context;
        this.postlist=stringArrayList;
        storage = FirebaseStorage.getInstance();
        // Create a storage reference from our app
        storageRef = storage.getReference();
    }
    public  void addData(List<HomepostResp> stringArrayList){
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final HomepostResp postdataItem = postlist.get(position);
