...
public class SearchBusinessItemsListAdapter extends RecyclerView.Adapter<SearchBusinessItemsListAdapter.ViewHolder> {
    ...
    public SearchBusinessItemsListAdapter(Context context, List<EventTagBusiness> stringArrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.imageViewIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.frame_layout, ItemDetailFragment.newInstance("115"));
