...
import com.numnu.android.adapter.search.SearchBusinessItemsListAdapter;
...
public class SearchBusinessItemsListFragment extends Fragment implements View.OnClickListener {
    ...
    private SearchBusinessItemsListAdapter eventItemsListAdapter;
    private ItemsByTagResponse eventItemsResponse;

    public static SearchBusinessItemsListFragment newInstance(String category, String businessId, String tagId) {

        SearchBusinessItemsListFragment eventBusinessFragment = new SearchBusinessItemsListFragment();
...
//        menuitemsRecyclerView.addItemDecoration(dividerItemDecoration);
    ...
    private void updateUI() {
        ...
        eventItemsListAdapter = new SearchBusinessItemsListAdapter(context, eventItemsResponse.getData());
